/**
* Ejemplo básico de streaming de video desde un Esp32-Cam conectando el microcontrolador a WiFi, pero en modo Access Point
*/
...
// Setup LED FLash if LED pin is defined in camera_pins.h
  ...
  //Start camera server
  startCameraServer();
  Serial.print("Camera Server Ready!");
}
